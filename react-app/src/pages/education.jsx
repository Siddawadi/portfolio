...
export const Education = () => {
  return (
    <div className='flex flex-col border-t-2 border-b-2 gap-3  items-center'>
        ...
        <div className=' min-w-[60vw]   min-h-50 mb-10 rounded-2xl hover:border-top-1 mr-10 flex flex-col mt-2 justify-center shadow-2xs
         shadow-green-400 hover:border-2 py-2'>
